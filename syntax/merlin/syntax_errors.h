  ...
  "invalid local label format (must be :LABEL)",ERROR,
  "local label without global label context",ERROR,
  "invalid variable label format (must be ]LABEL)",ERROR,
