/* syntax.h  syntax header file for vasm (SCMASM syntax) */
/* (c) in 2002,2012,2014,2017,2020,2025 by Frank Wille */
/* SCMASM syntax module adaptation (c) 2025 */

/* Enable SCASM-specific byte operators: \ (low-byte), / (high-byte) */
#define SYNTAX_SUPPORTS_SCASM_OPS

/* macros to recognize identifiers */
/* NOTE: Period '.' allowed in ISIDSTART for directive recognition, */
/* but excluded from ISIDCHAR to prevent use in regular identifiers */
int isidchar(char);
...
/* macro execution hook - increment private label context for each macro invocation */
